package edu.kh.collection.model.servcie;
...
public class SetService {
	...
	public void ex4() {
		...
		System.out.println("int 최소값 : " + w1.MAX_VALUE); // static
		
		System.out.println("int 최소값 : " + w2.MAX_VALUE); // static
		System.out.println("int 최소값 : " + w2.MAX_VALUE); // static
		...
		System.out.println("int 최소값 : " + Double.MAX_VALUE);
		System.out.println("int 최소값 : " + Double.MAX_VALUE);
		
		// *************************************************
		
		// pasrsing : 데이터의 형식을 변환
	...
	public void lotto() {
		...
		Set<Integer> lotto = new TreeSet<Integer>(); // 순서유지 Set	
